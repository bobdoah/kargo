...
func (p *provider) MergePullRequest(
	...
	// Merge the MR. When unspecified, the GitLab API uses the project's
	// configured default. Squash is supported via a boolean flag. Rebase is
	// not supported through the accept-merge-request API.
